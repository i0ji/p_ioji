...
export default function Card({ data }: { data: heroModel }) {
  ...
  return (
    <div
      className="mx-auto my-4 flex h-[90vh] w-[100vw] transform flex-col justify-between rounded-lg p-4 text-stone-300 transition-transform duration-200 ease-linear hover:scale-[1.01] sm:h-[50vh] md:h-[70vh] md:w-[60vw] md:bg-gray-800 md:shadow-lg md:drop-shadow-lg lg:h-[80vh] lg:w-[30vw] xl:h-[75vh] 2xl:h-[50vh] 2xl:w-[30vw]"
      data-carousel-item
    >
